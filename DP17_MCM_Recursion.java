...
public class DP17_MCM_Recursion {

    public static int MCM_Recursion(int arr[], int Start, int End) {
        ...
        for (int k = Start; k <= End - 1; k++) {
            ...
            int Cost1 = MCM_Recursion(arr, Start, k); // This Will From Matrix-1 Of Order [arr[Start-1]*arr[k]]......

            // Cost Of Mult. From Matrix-(k+1) To Matrix-(End).......
            // Order Of This Will Be Row(k+1)*Col(End) --> arr[k]*arr[End].......
            int Cost2 = MCM_Recursion(arr, k + 1, End); // This Will From Matrix-2 Of Order [arr[k]*arr[End]]......
    ...
    public static void main(String args[]) {
        int arr[] = { 1, 2, 3, 4, 3 };
        int n = arr.length;
        int ans = MCM_Recursion(arr, 1, n - 1);
        System.out.println("THE MIN. COST OF MCM IS ::: " + ans);
    }
}
